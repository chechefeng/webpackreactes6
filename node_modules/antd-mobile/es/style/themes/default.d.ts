declare const _default: {
    ...
    font_size_display_sm: number;
    font_size_display_md: number;
    font_size_display_lg: number;
    font_size_display_xl: number;
