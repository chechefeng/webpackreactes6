    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          _extends({}, other, {
            ref: 'indexedListView',
            className: classNames((_classNames = {}, _defineProperty(_classNames, className, className), _defineProperty(_classNames, prefixCls, true), _classNames)),
        ...
        showQuickSearchIndicator ? React.createElement('div', { className: classNames((_classNames2 = {}, _defineProperty(_classNames2, prefixCls + '-qsindicator', true), _defineProperty(_classNames2, prefixCls + '-qsindicator-hide', !showQuickSearchIndicator || !this.state.showQuickSearchIndicator), _classNames2)), ref: 'qsIndicator'
        }) : null
      );
    }
  }]);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onQuickSearchTop = function (sectionID, topId) {
    if (_this4.props.stickyHeader) {
      ...
      ReactDOM.findDOMNode(_this4.refs.indexedListView.refs.listviewscroll).scrollTop = 0;
    }
    _this4.props.onQuickSearch(sectionID, topId);
  };

  this.onQuickSearch = function (sectionID) {
    var lv = ReactDOM.findDOMNode(_this4.refs.indexedListView.refs.listviewscroll);
